...
class Activite {
    constructor(nom, type, duree, minJoueur, maxJoueur, difficulte, img, recompense) {
        this.nom = nom;
        this.type = type;
        this.duree = duree;
...
class Raid extends Activite {
    constructor(nom, duree, difficulte, img, etapes, recompense) {
        super(nom, "Raid", duree, 3, 6, difficulte, img, recompense)
        this.etapes = etapes;
    }
}
...
class Donjon extends Activite {
    constructor(nom, duree, difficulte, img, etapes, recompense) {
        super(nom, "Donjon", duree, 1, 3, difficulte, img, recompense)
        this.etapes = etapes;
    }
}
...
class Assaut extends Activite {
    constructor(nom, type, duree, difficulte, img, recompense) {
        super(nom, type, duree, 1, 3, difficulte, img, recompense)
    }
}

class NuitNoire extends Assaut {
    constructor(assaut, recompense) {
        super(assaut.nom, "Nuit Noire", assaut.duree * 2, assaut.difficulte + 2, assaut.img, recompense, recompense)
    }
}

class Mission extends Activite {
    constructor(nom, duree, difficulte, img, recompense) {
        super(nom, "Mission", duree, 1, 3, difficulte, img, recompense)
    }
}

class MissionExotique extends Mission {
    constructor(nom, duree, difficulte, img, recompense) {
        super(nom, duree, difficulte, img, recompense)
    }
}
...
const activites = [
    ...
    new Assaut("Le trafiquant d'armes", "Assaut", 10, 2, "strike_the_arms_dealer.jpg", "Légendaire"),
    new Assaut("Crash de l'Exode", "Assaut", 15, 3, "strike_exodus_crash.jpg", "Légendaire"),
    new Assaut("La corrompu", "Assaut", 15, 3, "strike_gemini.jpg", "Légendaire"),


    new NuitNoire(new Assaut("Le trafiquant d'armes", "Nuit Noire", 10, 2, "strike_the_arms_dealer.jpg"), "Légendaire"),
    new NuitNoire(new Assaut("Crash de l'Exode", "Nuit Noire", 15, 3, "strike_exodus_crash.jpg"), "Légendaire"),
    new NuitNoire(new Assaut("La corrompu", "Assaut", 15, 3, "strike_gemini.jpg"), "Légendaire"),

    new Mission("Le retour d'Uldren", 20, 2, "mission_uldren.jpg", "Légendaire"),
    new Mission("La forme finale", 40, 6, "tfs_m1.jpg", "Légendaire"),
    new MissionExotique("Mauvais présage", 20, 7, "edz_exotic_harbinger.jpg", "Exotique"),
    new MissionExotique("Le murmure du ver", 20, 8, "whisper.jpg", "Exotique")
